...
function TTOM:InitializeOptions()
	...
	xEdit:HookScript("OnEnterPressed", function(self)
		xEdit:ClearFocus()
	end)
	xEdit:HookScript("OnEscapePressed", function(self)
		xEdit:ClearFocus()
	end)
	...
	yEdit:HookScript("OnEnterPressed", function(self)
		yEdit:ClearFocus()
	end)
	yEdit:HookScript("OnEscapePressed", function(self)
		yEdit:ClearFocus()
	end)
